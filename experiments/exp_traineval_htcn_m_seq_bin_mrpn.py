...
def exp_htcn_mixed(cfg_file, output_dir, dataset_source, m_dataset_target,
    ...
    for epoch in range(start_epoch, max_epochs + 1):
        ...
        total_step = frcnn_utils.train_htcn_one_epoch_multi_targets_seq_binary(args, FL, total_step, dataloader_s, m_dataloader_t, iters_per_epoch, fasterRCNN, optimizer, device, logger)
...
if __name__ == "__main__":
    ...
    ex.run(config_updates={'cfg_file': 'cfgs/vgg16.yml'},
           options={"--name": 'htcn_seq_bin_kitti_2_city_water_vgg16_mrpn'})