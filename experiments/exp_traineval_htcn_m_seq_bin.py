...
def exp_htcn_mixed(cfg_file, output_dir, dataset_source, m_dataset_target,
    ...
    for epoch in range(start_epoch, max_epochs + 1):
        ...
        total_step = pw_frcnn_utils.train_htcn_one_epoch_mt_seq_binary(args, FL, total_step, dataloader_s, m_dataloader_t, iters_per_epoch, fasterRCNN, optimizer, device, logger)
...
if __name__ == "__main__":
    ...
    ex.run(config_updates={'cfg_file': 'cfgs/vgg16.yml'},
           options={"--name": 'htcn_seq_bin_voc_2_clip_comic_water_vgg16'})