...
__D.CITYSCAPE = os.path.expanduser("datasets_syslink/cityscape_matlab/")
...
__D.FOGGYCITY = os.path.expanduser("datasets_syslink/foggycityscape_mat/")
__D.BDD10K = os.path.expanduser("datasets_syslink/bdd10k/")
__D.RAINCITY = os.path.expanduser("datasets_syslink/rainyCityscape/")
