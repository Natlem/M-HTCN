...
class wildtrack(imdb):
    def __init__(self, image_set, camera, devkit_path=None):
        imdb.__init__(self, 'wildtrack' + camera + '_' + image_set)
        #for wildtrack_year = camera

        self._year = "2007"
        self._image_set = image_set
        self._devkit_path = cfg_d.WILDTRACK + "VOC_{}".format(camera)
